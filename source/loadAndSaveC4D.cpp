...
Bool BuildMaterialToC4D(AlienMaterial* pOrgMat, BaseDocument* doc)
{
    if (!doc)
    {
        return false;
...
Bool BuildLayerToC4D(AlienLayer* myInternalLayer, AlienLayer* parentLayer, BaseDocument* doc)
{
...
BaseObject* CreateObjectToC4D(BaseObject* myInternalObject, BaseObject* pParent, BaseDocument* doc)
{
...
BaseObject* BuildObjectsToC4D(BaseObject* obj, BaseObject* pNewParent, BaseDocument* doc)
{
